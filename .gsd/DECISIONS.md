...
| D013 | M001 | auth | Authentication error handling | Use generic Exception | mistapi doesn't expose a specific exceptions module; catch generic Exception for auth failures and re-raise with context | Yes — if mistapi adds exception types |